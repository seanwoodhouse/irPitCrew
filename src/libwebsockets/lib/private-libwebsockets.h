...
//#define LWS_MAX_HEADER_LEN 1024 // SW  too small
#define LWS_MAX_HEADER_LEN 10240
#endif
...
// SW
// This buffer is causing problems once files to send become larger.
// I believe this is due to the send code trying to send tags (ie <body>)
// in chunks, but I'm not sure.
// The code failing is in lws_handshake_server() and libwebsocket_read().
// lws_handshake_server() should get to the end and return 0.  It doesn't 
// if this buffer is small.
//
// Just make it big.  Default was 1024, go 100K.
//
//#define LWS_MAX_SOCKET_IO_BUF 4096
#define LWS_MAX_SOCKET_IO_BUF 102400
...
int lws_context_init_server(struct lws_context_creation_info *info,
			    struct libwebsocket_context *context);
LWS_EXTERN int handshake_00(struct libwebsocket *wsi);
